...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen bg-background flex items-center justify-center overflow-hidden">
      ...
      <GlowOrbs colors={['#b20e38', '#8b5cf6', '#22c55e']} />
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        >
          {/* Logo */}
          <Link href="/" className="login-title block text-center mb-8">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="login-form-element flex items-center justify-between">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="login-form-element w-full btn-primary py-4 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
          ...
          {/* Divider */}
          <div className="login-form-element flex items-center gap-4 my-8">
          ...
          {/* Social login */}
          <div className="login-form-element flex gap-4">
            <button 
              type="button"
              className="flex-1 py-3 rounded-xl bg-white/5 border border-white/10 text-white/70 hover:bg-white/10 hover:text-white transition-all flex items-center justify-center gap-2"
            >
          ...
          {/* Sign up link */}
          <p className="login-form-element text-center text-white/50 mt-8">
